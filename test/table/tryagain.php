...
<body style="background: linear-gradient(to top, #c5c09a, #f1f1dd); width:100%; height:100vh;position:relative;">
  <div class="drop_area">
    <p id="input_name_p"><a href="../upload.html" style="color:black;text-decoration: none;">L. monocytogenes global tracking web tool</a></p>
    <p id="sample"><a href="./sample.html" style="color:black;">Input/Output<br>Sample</a></p>
        ...
        <script type="text/javascript">
          ...
          function check() {
            if (nextAddress < index_count) {
              setTimeout("codeAddress('" + germ_geo[nextAddress][0] + "', '" + germ_geo[nextAddress][1] + "',"+nextAddress+")", delay);
              nextAddress++;
            }
          }
          
          function user_location() {
            codeAddress('<?php echo $user_country; ?>', -1, -1); //使用者的位置
            check();
          }
            
          //////api 開抓///////
          function codeAddress(geo, num, num_array) {
            var address = geo;
            var lat;
            var lng;
  ...
  <div>
    <div style="position:absolute; display: block-inline; left:15px;">
      <p>瀏覽人數:
        <img style="width: 70px;" src="https://hitwebcounter.com/counter/counter.php?page=7816344&style=0007&nbdigits=5&type=page&initCount=0" title="Free Counter" Alt="web counter" /></a>
      </p>
    </div>
