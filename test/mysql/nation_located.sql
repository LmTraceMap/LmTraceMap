...
--
-- 資料庫： `L__monocytogenes_global_tracking_web_tool`
--

-- --------------------------------------------------------

--
-- 資料表結構 `nation_located`
--

CREATE TABLE `nation_located` (
  `nation` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `longtitude` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `latitude` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;

--
-- 傾印資料表的資料 `nation_located`
--

INSERT INTO `nation_located` (`nation`, `longtitude`, `latitude`) VALUES
('Afghanistan', '67.709953', '33.93911'),
('Aland Islands', '19.9156105', '60.1785247'),
...
('Croatia (Hrvatska)', '15.2000001', '45.1'),
...
('Estonia', '25.0136071', '58.595272'),
('Ethiopia', '40.489673', '9.145'),
('Falkland Islands (Malvinas)', '-59.523613', '-51.796253'),
('Faroe Islands', '-6.9118061', '61.892635'),
('Federated States of Micronesia', '150.550812', '7.425554'),
('Fiji', '178.065032', '-17.713371'),
('Finland', '25.7481511', '61.92411'),
('France', '2.213749', '46.227638'),
('France, Metropolitan', '-93.3295898', '44.8704338'),
...
('Great Britain (UK)', '-2.4290148', '53.8337367'),
...
('Korea (North)', '127.510093', '40.339852'),
...
('Palestinian', '-94.749713', '38.902439'),
...
('Pitcairn', '-128.3242376', '-24.3767537'),
...
('S. Georgia', '-36.5827165', '-54.4138333'),
('Saint Helena', '-5.7089241', '-15.9650104'),
('Saint Kitts and Nevis', '-62.782998', '17.357822'),
('Saint Lucia', '-60.978893', '13.909444'),
('Saint Pierre and Miquelon', '-56.3159', '46.8852'),
...
--
-- 資料表索引 `nation_located`
--
ALTER TABLE `nation_located`
